    ...
    <section id="skills" className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 fade-in-up">
          <h2 className="text-4xl font-headline font-bold text-primary sm:text-5xl">Our Arsenal of Skills</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {Object.entries(skillsByCategory).map(([category, skills], index) => (
            <div key={category} className="bg-secondary/50 rounded-lg p-8 border border-border/50 fade-in-up" style={{ animationDelay: `${index * 0.1 + 0.2}s` }}>
